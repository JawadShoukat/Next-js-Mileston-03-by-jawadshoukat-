...
const Slide:React.FC<propsType> = ({img, title, mainTitle, price}) => {
  return <div className='outline-none border-none relative'>
    <div className="absolute left-[30px] md:left-[70px] max-w[250px] sm:max-w-[360px] top-[50%]
    ...
    sm:rounded-none">
        ...
        <div className='bg-sky text-white text-[14px] md:text-[16px] p-2 px-4 rounded-lg inline-block
